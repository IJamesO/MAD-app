...
export default function SocialProfile() {
  ...
  return (
    <div className="pb-20 overflow-x-hidden max-w-full">
      {/* Cover Image */}
      <div className="h-48 bg-gradient-to-br from-primary/20 via-primary/5 to-transparent rounded-b-[3rem] -mt-6 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#0F6A6A_1px,transparent_1px)] [background-size:20px_20px]" />
      </div>
        ...
        <div className="flex flex-col gap-6">
          <div className="space-y-4">
            <motion.div
              ...
              className="w-32 h-32 bg-white p-2 rounded-[2.5rem] shadow-2xl"
            >
          ...
          <div className="flex items-center gap-3">
            <button className="flex-1 bg-primary text-white font-black px-8 py-3.5 rounded-2xl shadow-xl shadow-primary/20 hover:bg-primary-dark transition-all active:scale-95 flex items-center justify-center gap-2 text-xs uppercase tracking-widest">
              <UserPlus size={18} /> Follow
            </button>

            <button className="p-3.5 bg-white border border-border text-gray-500 rounded-2xl shadow-sm">
              <Share2 size={18} />
            </button>
        ...
        <div className="grid grid-cols-1 gap-8 mt-12">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-3xl border border-border p-8 shadow-sm space-y-6">
              ...
              <p className="text-gray-600 font-medium leading-relaxed text-sm">
                Passionate software engineering student at Salford. Focused on
                building user-centric academic tools and exploring distributive
                systems. 💻✨
              </p>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-3xl border border-border p-4 shadow-sm flex items-center gap-2">
              ...
              <button className="flex-1 py-3 rounded-xl text-xs font-black uppercase tracking-widest text-gray-400">
                Media
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[1, 2, 3, 4].map((post) => (
                <motion.div
                  ...
                  className="aspect-square bg-gray-100 rounded-[2rem] border border-border overflow-hidden relative"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent opacity-0 hover:opacity-100 transition-opacity flex items-center justify-center">
